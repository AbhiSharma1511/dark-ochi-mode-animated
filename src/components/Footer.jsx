...
const Footer = () => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      variants={variants}
      className="border-t-2 border-zinc-500 mt-8 pt-8 flex flex-col overflow-hidden"
    >
      <div className="flex md:flex-row flex-col px-10 justify-between overflow-cut">
        <div className="sm:text-[6vw] text-[5vh] leading-none tracking-tighter font-semibold uppercase">
          <h2>Eye-</h2>
          <h2>Opening</h2>
        </div>
        <div className="flex flex-col gap-10 md:mb-20 mb-5">
          <h2 className="sm:text-[6vw] text-[5vh] leading-none tracking-tighter font-semibold uppercase">
            Presentations
          </h2>
          <div>
            <div>
              <h2>S:</h2>
              <h2 className="text-transparent">nnn</h2>
            ...
            <div className="flex justify-between md:mr-20 mt-10">
              <div>
                <h2>L:</h2>
                <h2 className="text-transparent">nnn</h2>
                <h2 className="underline">202-1965 W 4th Ave</h2>
                <h2 className="underline">Vancouver, Canada</h2>
                <h2 className="text-transparent">nnn</h2>
                <h2 className="underline">30 Chukarina St</h2>
                <h2 className="underline">Lviv, Ukraine</h2>
              </div>
              <div>
                <h2>M:</h2>
                <h2 className="text-transparent">nnn</h2>
      ...
      <div className="w-[95%] flex md:flex-row flex-col justify-between md:items-center gap-5 px-6 pb-2">
        <svg
          className=" text-white md:mb-0 mb-5"
          width="80"
          height="50"
          viewBox="0 0 72 30"
          fill="none"
        ...
        <h2>
          &copy; ochi design 2024. <a className="underline">Legal Terms</a>
        </h2>
        <h2>Website by Obys</h2>
      </div>
    </motion.div>
  );
};
